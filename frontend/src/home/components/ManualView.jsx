...
export function ManualView(props) {
    ...
    const serv = appState.manualConfig.find(i => i.lemon2id == props.lemon2id)
    ...
    const submit = async () => {
        ...
        if (typeof content == 'string') {
            Modal.fail(language.TheConfigurationIsNotInJsonFormatPleaseModifyIt)
            return
        }
    ...
    return <div className={cx('flex1 pp15 br7')} style={{ width: '80vw', maxHeight: 'calc(100vh - 100px)', background: '#fff', overflow: 'scroll' }}>
        <div className='ui-flex fs11' >
            <span className="flex1"></span>
            <Button onClick={resetState} className='mr10 modal-close' theme="cancel">
                Cancel
            </Button>
