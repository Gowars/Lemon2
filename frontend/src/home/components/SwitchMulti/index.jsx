...
export function SwitchMulti(props) {
    ...
    return <div className={S.withTips} onMouseLeave={() => setState({ hoverId: '' })}>
        <div className={S['tabs']} ref={d}>
            {data.map(i => {
                return <div
                    className={cx(value === i.value && S.active, S.item)}
        ...
        {
            !!(data.find(i => i.text == state.hoverId)?.desc) && <div className={S.desc}>
